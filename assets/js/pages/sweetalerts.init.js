...
}), document.getElementById("sa-simpan") && document.getElementById("sa-simpan").addEventListener("click", function () {
    var t;
    Swal.fire({
        icon: "success",
        title: "Yeay.. Data Berhasil Disimpan!",
        html: "Silahkan  <strong></strong> tunggu...",
        timer: 2e3,
        timerProgressBar: !0,
        showCloseButton: !0,
        didOpen: function () {
...
}), document.getElementById("sa-hapus") && document.getElementById("sa-hapus").addEventListener("click", function () {
    var t;
    Swal.fire({
        icon: "danger",
...
}), document.getElementById("custom-sa-hapus") && document.getElementById("custom-sa-hapus").addEventListener("click", function () {
    Swal.fire({
